...
<body>
	...
	<%
		...
		String userage = request.getParameter("iage");
	...
	<div class="mainP">
		<h1>My Story</h1>
		<hr>
		<form action="research_update.jsp" method=post>
			<table border=0 align=center width='1024' class="txt" align=center>
				<th colspan="5">설 문 조 사</th>
				<tr>
				...
				<tr>
					<td><span>나이</span></td>
					<td colspan="2" width=300 class="formEle"><input type="text"
						size="2" name="iage" maxlength="2" value="<%=userage%>"><span>세</span>
					</td>
					<td width=100><span>성별</span></td>
					<td class="formEle"><input type="radio" name="igender" checked
						value="남"><span>남</span> <input type="radio"
						name="igender" value="여"><span>여</span></td>
				</tr>
				<tr>
					<td width=100><span>취미</span></td>
					<td colspan=4 class="formEle"><input type="checkbox"
						name="ihob" value=1><span>낚시</span> <input type="checkbox"
						name="ihob" value=2><span>여행</span> <input type="checkbox"
						name="ihob" value=3><span>방콕</span> <input type="checkbox"
						name="ihob" value=4><span>쇼핑</span></td>
				</tr>
				<tr>
					<td width=100><span>지역</span></td>

					<td colspan=4 class="formEle"><select name="icity">
				...
				<tr>
					...
					<td colspan="3" class="formEle"><textarea name="ibody"
